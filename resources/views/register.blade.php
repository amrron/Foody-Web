...
@section('container')
<div class="container-lg position-relative" style="margin-top: 120px; margin-bottom: 20px; max-width: 480px; z-index: 50">
    <form action="" method="post" class="">
        @csrf
        <h3 class="judul text-center text-biru">Register</h3>
        ...
        <div class="d-grid gap-2 mb-3d">
            <button class="tombol tombol-biru" type="submit">Buat Akun</button>
        </div>
        <figure class="text-center">
            <figcaption class="blockquote-footer">
...
<div class="d-none d-md-block" style="position: absolute; top: 0; right: 0; filter: blur(42.5px);">
...
<div class="d-none d-md-block" style="position: absolute; left: 0; bottom: 355px; filter: blur(42.5px);">

            ...
            <table class="table table-borderless border table-hover">
                ...
                <tbody>
                    ...
                    <tr class="align-middle">
                        ...
                        <td class="">
                            <div class="d-flex">
                                <a href="/adminpanel/fooddata/edit/{{ $food->id }}" class="btn p-1 px-2 bg-biru-muda me-1">
                        ...
                        <td><img src="{{ str_contains($food->gambar, "upload/") ? asset('storage/' . $food->gambar) : $food->gambar }}" class="rounded-1" alt="" style="height: 100px; width: 150px; object-fit: cover;"></td>
